                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    <Dialog.Title as="h3" className="text-3xl leading-6 font-bold text-[#1B053B] text-center">
                                    ...
                                    >
                                        ...
                                        <input
                                            type="submit"
                                            className='bg-[#1B053B] hover:bg-[#F5C116] w-full p-3 text-white uppercase font-bold cursor-pointer transition-colors rounded text-sm'
